...
class dsl_cpp_generator
{
  ...
  //void generateAssignmentStmt(assignment* assignStmt);
   void generateAssignmentStmt(assignment* assignStmt, bool );
  ...
  void generateBFS();
  void generateBlock(blockStatement* blockStmt, bool includeBrace=true, bool isMainFile = false);
  ...
  void generateVariableDeclForEdge(declaration* declStmt, bool isMainFile);
