#ifndef MULTIGPU_DSL_CPP_GENERATOR
#define MULTIGPU_DSL_CPP_GENERATOR
...
class dsl_cpp_generator {
 ...
 public:
  ...
  void generateBody(reductionCallStmt *stmt,bool isMainFile);
  void generateId();
  void generateOid();
