...
__global__ void compute_colors(int start,int end,int V, int E, int* d_meta, int* d_data, int* d_src,int *d_rev_meta,unsigned int* d_color,bool* d_modified,bool* d_modified_next,int* d_fpoint1){
