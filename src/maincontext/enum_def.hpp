...
inline bool check_isCollectionType(int typeId) {
  return ((typeId == TYPE_LIST) || (typeId == TYPE_SETE) ||
          (typeId == TYPE_SETN) || (typeId == TYPE_UPDATES) ||
          (typeId == TYPE_NODEMAP) || (typeId == TYPE_CONTAINER));
}
...
inline bool check_isPrimitiveType(int typeId) {
  return ((typeId == TYPE_BOOL) || (typeId == TYPE_DOUBLE) ||
          (typeId == TYPE_FLOAT) || (typeId == TYPE_LONG) ||
          (typeId == TYPE_INT));
}

inline bool check_isPropNodeType(int typeId) { return typeId == TYPE_PROPNODE; }

inline bool check_isPropEdgeType(int typeId) { return typeId == TYPE_PROPEDGE; }
...
inline bool check_isNodeType(int typeId) { return typeId == TYPE_NODE; }
inline bool check_isEdgeType(int typeId) { return typeId == TYPE_EDGE; }
inline bool check_isContainerType(int typeId) {

  return typeId == TYPE_CONTAINER;
}
inline bool check_isNodeMapType(int typeId) { return typeId == TYPE_NODEMAP; }
inline bool check_isDSUType(int typeId) { return typeId == TYPE_DSU; }
...
inline std::string expr_str(int expr) {
  switch(expr) {
  ...
  case EXPR_BOOLCONSTANT:
    return "EXPR_BOOLCONSTANT";
  case EXPR_INTCONSTANT:
    return "EXPR_INTCONSTANT";
  case EXPR_LONGCONSTANT:
    return "EXPR_LONGCONSTANT";
  case EXPR_DOUBLECONSTANT:
    return "EXPR_DOUBLECONSTANT";
  case EXPR_FLOATCONSTANT:
    return "EXPR_FLOATCONSTANT";
  case EXPR_ID:
    return "EXPR_ID";
  case EXPR_PROPID:
    return "EXPR_PROPID";
  case EXPR_INFINITY:
    return "EXPR_INFINITY";
  case EXPR_PROCCALL:
    return "EXPR_PROCCALL";
  case EXPR_DEPENDENT:
    return "EXPR_DEPENDENT";
  case EXPR_MAPGET:
    return "EXPR_MAPGET";
  default:
    return "invalid expr";
