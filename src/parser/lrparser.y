...
%token T_GRAPH T_DIR_GRAPH  T_NODE T_EDGE T_UPDATES T_CONTAINER T_NODEMAP T_DSU
%token T_NP  T_EP
...
%type <node> primitive graph collections property container nodemap dsu
...
dsu : T_DSU { $$=Util::createDSUTypeNode(TYPE_DSU);} ;
