...
graph_construct : '(' T_FORWARD '<' id ',' id ',' T_COND '(' boolean_expr ')' '>' filterExpr T_UNTIL '(' id ':' expression ')' ')' T_AND_OP '(' boolean_expr ')' {			Expression* a=(Expression*)$23;
				...
				| T_GC '<' id ',' filterExpr ',' id ',' id ',' id ',' id'>' {		ASTNode* b=Util::createIdentifierNode("src");
																					...
																					ASTNode* o=Util::createIdentifierNode("ext");
																					...
																					Util::createNewBlock();
																					ASTNode* y=Util::createIdentifierNode("ext");
																					...
																					Util::createNewBlock();
																					ASTNode* h1=Util::createIdentifierNode("ext");
																					ASTNode* i1=Util::createNodeForIval(2);
																					...
																					ASTNode* s2=Util::createAssignedDeclNode(m1, n1, r1);
																					Util::addToBlock(s2);
																					...
																					ASTNode* s1=Util::createIdentifierNode("ext");
																					ASTNode* n2=Util::createNodeForId(s1);
																					ASTNode* p2=Util::createNodeForId(y1);
																					ASTNode* t1=Util::createNodeForArithmeticExpr(n2, p2, OPERATOR_ADD);
																					ASTNode* z2=Util::createAssignmentNode(x1, t1);
																					Util::addToBlock(z2);
