...
#line 92 "dsl_yacc_modified.tab.c"
...
#line 220 "dsl_yacc_modified.tab.c"
...
#line 86 "dsl_yacc_modified.y"
                      {printf("program.\n");}
#line 1579 "dsl_yacc_modified.tab.c"
    break;

  case 3:
#line 88 "dsl_yacc_modified.y"
                                            { }
#line 1585 "dsl_yacc_modified.tab.c"
    break;
...
#line 1611 "dsl_yacc_modified.tab.c"
    break;
...
#line 98 "dsl_yacc_modified.y"
                          {  Identifier* id=createIdentifierNode((yyvsp[0].text));
                             (yyval.node)=createParamNode((yyvsp[-1].node),id);}
#line 1618 "dsl_yacc_modified.tab.c"
    break;
...
#line 1709 "dsl_yacc_modified.tab.c"
    break;
...
#line 1716 "dsl_yacc_modified.tab.c"
    break;
...
#line 135 "dsl_yacc_modified.y"
                    {Identifier* id=createIdentifierNode((yyvsp[0].text));
                         (yyval.node)=createNormalDeclNode((yyvsp[-1].node),id); }
#line 1723 "dsl_yacc_modified.tab.c"
    break;
...
#line 2173 "dsl_yacc_modified.tab.c"
    break;
...
#line 2183 "dsl_yacc_modified.tab.c"
    break;
...
#line 251 "dsl_yacc_modified.y"
						 ...
						 a1.expressionflag=true;
						  (yyval.aList)=addToAList((yyval.aList),a1); }
#line 2192 "dsl_yacc_modified.tab.c"
    break;
...
#line 255 "dsl_yacc_modified.y"
						  ...
						  a1.assign=true;
						   (yyval.aList)=addToAList((yyval.aList),a1);}
#line 2201 "dsl_yacc_modified.tab.c"
    break;
...
#line 2222 "dsl_yacc_modified.tab.c"
    break;


#line 2226 "dsl_yacc_modified.tab.c"
