...

{
  ...
  //BEGIN DSL PARSING 
  bool* d_visited;
  cudaMalloc(&d_visited, sizeof(bool)*(V));

  initKernel<bool> <<<numBlocks,threadsPerBlock>>>(V,d_visited,(bool)false);

  v_cover_kernel<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_visited);
