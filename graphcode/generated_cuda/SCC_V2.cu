...
cudaMalloc(&d_isMSTEdge, sizeof(bool)*(1));
  ...
  vHong_kernel_1<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_outDeg,d_inDeg,d_isMSTEdge);
  ...
  while(!fpoint1) {
    ...
    cudaMemcpyToSymbol(::fpoint1, &fpoint1, sizeof(bool), 0, cudaMemcpyHostToDevice);
    vHong_kernel_2<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_scc,d_range,d_isPivot,d_isMSTEdge);
    cudaDeviceSynchronize();
  ...
  vHong_kernel_3<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_inDeg,d_scc,d_outDeg,d_pivotField,d_range,d_isMSTEdge);
  cudaDeviceSynchronize();
  ...
  vHong_kernel_4<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_scc,d_pivotField,d_range,d_visitFw,d_visitBw,d_isPivot,d_isMSTEdge);
  cudaDeviceSynchronize();
  ...
  while(!fpoint2) {
    ...
    cudaMemcpyToSymbol(::fpoint2, &fpoint2, sizeof(bool), 0, cudaMemcpyHostToDevice);
    vHong_kernel_5<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_visitBw,d_propFw,d_scc,d_propBw,d_range,d_visitFw,d_isMSTEdge);
    cudaDeviceSynchronize();
  ...
  vHong_kernel_6<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_scc,d_range,d_visitBw,d_visitFw,d_propBw,d_propFw,d_isMSTEdge);
  cudaDeviceSynchronize();
  ...
  while(!fpoint1) {
    ...
    cudaMemcpyToSymbol(::fpoint1, &fpoint1, sizeof(bool), 0, cudaMemcpyHostToDevice);
    cudaMemcpyToSymbol(::fpoint1, &fpoint1, sizeof(bool), 0, cudaMemcpyHostToDevice);
    vHong_kernel_7<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_scc,d_range,d_isPivot,d_isMSTEdge);
    cudaDeviceSynchronize();
    cudaMemcpyFromSymbol(&fpoint1, ::fpoint1, sizeof(bool), 0, cudaMemcpyDeviceToHost);
  ...
  vHong_kernel_8<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_range,d_isMSTEdge);
  cudaDeviceSynchronize();
  ...
  while(!fpoint4) {
    ...
    cudaMemcpyToSymbol(::fpoint4, &fpoint4, sizeof(bool), 0, cudaMemcpyHostToDevice);
    vHong_kernel_9<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_scc,d_range,d_isMSTEdge);
    cudaDeviceSynchronize();
    ...
    cudaMemcpyToSymbol(::fpoint4, &fpoint4, sizeof(bool), 0, cudaMemcpyHostToDevice);
    vHong_kernel_10<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_scc,d_range,d_isMSTEdge);
    cudaDeviceSynchronize();
    cudaMemcpyFromSymbol(&fpoint4, ::fpoint4, sizeof(bool), 0, cudaMemcpyDeviceToHost);
  ...
  while(!fpoint5) {
    ...
    vHong_kernel_11<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_inDeg,d_scc,d_outDeg,d_pivotField,d_range,d_isMSTEdge);
    cudaDeviceSynchronize();
    ...
    vHong_kernel_12<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_scc,d_pivotField,d_range,d_visitFw,d_visitBw,d_isPivot,d_isMSTEdge);
    cudaDeviceSynchronize();
    ...
    while(!fpoint2) {
      ...
      cudaMemcpyToSymbol(::fpoint2, &fpoint2, sizeof(bool), 0, cudaMemcpyHostToDevice);
      cudaMemcpyToSymbol(::fpoint2, &fpoint2, sizeof(bool), 0, cudaMemcpyHostToDevice);
      vHong_kernel_13<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_visitBw,d_propFw,d_scc,d_propBw,d_range,d_visitFw,d_isMSTEdge);
      cudaDeviceSynchronize();
      cudaMemcpyFromSymbol(&fpoint2, ::fpoint2, sizeof(bool), 0, cudaMemcpyDeviceToHost);
    ...
    cudaMemcpyToSymbol(::fpoint5, &fpoint5, sizeof(bool), 0, cudaMemcpyHostToDevice);
    vHong_kernel_14<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_scc,d_range,d_visitBw,d_visitFw,d_propBw,d_propFw,d_isMSTEdge);
    cudaDeviceSynchronize();
