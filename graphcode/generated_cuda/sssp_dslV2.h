...
__global__ void Compute_SSSP_kernel(int V, int E, int* d_meta, int* d_data, int* d_src, int* d_weight,bool* d_modified,bool* d_modified_next,int* d_dist,int* d_wt){ // BEGIN KER FUN via ADDKERNEL
  float num_nodes  = V;
