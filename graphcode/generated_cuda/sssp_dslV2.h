...
__global__ void Compute_SSSP_kernel(int V, int E, int* d_meta, int* d_data,bool* d_modified,bool* d_modified_next,int* d_wt,int* d_dist){ // BEGIN KER FUN via ADDKERNEL
  float num_nodes  = V;
