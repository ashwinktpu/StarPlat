...

{
  ...
  vHong_kernel<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_outDeg,d_inDeg);
  ...
  while(!fpoint1) {
    ...
    cudaMemcpyToSymbol(::fpoint1, &fpoint1, sizeof(bool), 0, cudaMemcpyHostToDevice);
    vHong_kernel<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_range,d_scc,d_isPivot);
    cudaDeviceSynchronize();
  ...
  vHong_kernel<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_scc,d_outDeg,d_inDeg,d_pivotField,d_range);
  cudaDeviceSynchronize();
  ...
  vHong_kernel<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_scc,d_pivotField,d_range,d_isPivot,d_visitBw,d_visitFw);
  cudaDeviceSynchronize();
  ...
  while(!fpoint2) {
    ...
    cudaMemcpyToSymbol(::fpoint2, &fpoint2, sizeof(bool), 0, cudaMemcpyHostToDevice);
    vHong_kernel<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_propBw,d_visitBw,d_propFw,d_visitFw,d_scc,d_range);
    cudaDeviceSynchronize();
  ...
  bool fpoint5 = true; // asst in .cu

  cudaMemcpyToSymbol(::fpoint5, &fpoint5, sizeof(bool), 0, cudaMemcpyHostToDevice);
  vHong_kernel<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_src,d_weight,d_rev_meta,d_modified_next,d_scc,d_visitFw,d_visitBw,d_range,d_propBw,d_propFw);
  cudaDeviceSynchronize();
