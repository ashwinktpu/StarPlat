...
do
	...
	./graph_gen.out $i $((100*$i))
	./control.out input.txt > outputControl.txt
	echo "size of fize = $((100*$i))" >> ../unOptimizedScript/timingsFile
	/lfs/sware/openmpi411/bin/mpirun -np 20 anupDsl.out input.txt outputActual.txt >> ../unOptimizedScript/timingsFile
