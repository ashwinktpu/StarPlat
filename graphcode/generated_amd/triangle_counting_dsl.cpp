...
void Compute_TC(graph& g)
{
  ...
  cl_mem d_triangle_count= clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(long), NULL, &status);

  long triangle_count = 0; 

  //ForAll started here

  status = clEnqueueWriteBuffer(command_queue, d_triangle_count, CL_TRUE, 0, sizeof(long),&triangle_count , 0, NULL, NULL);
  ...
  status = clEnqueueReadBuffer(command_queue, d_triangle_count, CL_TRUE, 0, sizeof(long),&triangle_count , 0, NULL, NULL);
