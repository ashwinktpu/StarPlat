...
__kernel void Compute_PR_kernel(int V,  int E, __global int* d_meta, __global int* d_data, __global int* d_src,
  __global int* d_weight,__global int* d_rev_meta,__global float *d_diff,__global float *d_num_nodes,__global float *d_delta,__global float* d_pageRank,__global float* d_pageRank_nxt){ // BEGIN KER FUN via ADDKERNEL
