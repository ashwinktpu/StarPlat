...
class Graph
{
  private:
  bool undirected;
  int32_t nodesTotal; // depricate.
  int32_t edgesTotal; // depricate.
  int32_t global_vertices ;
  int32_t local_vertices ;
  int32_t local_edges ;
  int32_t global_edges ;
  ...
  Rma_Datatype<int32_t> srcProc; 
  Rma_Datatype<int32_t> destProc;
